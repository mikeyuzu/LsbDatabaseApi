namespace LsbDatabaseApi.@struct
{
    ...
    public enum MissionSandoria
    {
        ...
        JOURNEY_TO_BASTOK = 6,          // 他国を回れ バストゥーク前半ルート
        JOURNEY_TO_WINDURST = 7,        // 他国を回れ ウィンダス前半ルート
        JOURNEY_TO_BASTOK2 = 8,         // 他国を回れ バストゥーク後半ルート
        JOURNEY_TO_WINDURST2 = 9,       // 他国を回れ ウィンダス後半ルート
    ...
    public enum MissionBastok
    {
        ...
        THE_EMISSARY_SANDORIA = 6,      // バストゥークを離れて サンドリア前半ルート
        THE_EMISSARY_WINDURST = 7,      // バストゥークを離れて ウィンダス前半ルート
        THE_EMISSARY_SANDORIA2 = 8,     // バストゥークを離れて サンドリア後半ルート
        THE_EMISSARY_WINDURST2 = 9,     // バストゥークを離れて ウィンダス後半ルート
    ...
    public enum MissionWindurst
    {
        ...
        THE_THREE_KINGDOMS_SANDORIA = 6,    // 三大強国 サンドリア前半ルート
        THE_THREE_KINGDOMS_BASTOK = 7,      // 三大強国 バストゥーク前半ルート
        THE_THREE_KINGDOMS_SANDORIA2 = 8,   // 三大強国 サンドリア後半ルート
        THE_THREE_KINGDOMS_BASTOK2 = 9,     // 三大強国 バストゥーク後半ルート
